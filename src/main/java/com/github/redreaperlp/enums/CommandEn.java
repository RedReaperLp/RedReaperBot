...
public enum CommandEn {
    ...
    CLEAR("clear", "Clears a specific number of Messages (of an specific User within the last x messages)",
            new CommandOptions("amount", "Clears a specified amount of Messages in current channel", true, OptionType.INTEGER),
            new CommandOptions("user", "Clear only the provided Users messages within the specified amount", false, OptionType.USER)),
    ...
    BAN("ban", "Bans a mentioned User with an Reason",
            new CommandOptions("user", "The user, who should be banned", true, OptionType.USER),
            new CommandOptions("reason", "The reason why the user is banned", true, OptionType.STRING),
            new CommandOptions("days", "The amout of days the Messages from this User will be deleted", false, OptionType.INTEGER));
